    ...
    return (
        <form id="starter" onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <Dropdown selectName={"Use"} options={['Confortable daily driving', 'Fun daily driving', 'Fun side vehicle']} onChange={handleDropdownChange} />

            </div>
            <div>
                <label htmlFor="model">What is your preferred seating capacity:</label>
                <Dropdown selectName={"Seating Capacity"} options={['No preference', 'Two-seater', 'Four-seater', 'Seven-seater or more']} onChange={handleDropdownChange} />

            </div>
            <div>
                <label htmlFor="year">What is your preferred type of transmission: </label>
                <Dropdown selectName={"Type of Transmission"} options={['No preference', 'Manual', 'Automatic']} onChange={handleDropdownChange} />
            </div>
            <div>
                <label htmlFor="year">How safe would you like your vehicle to be: </label>
                <Dropdown selectName={"Safety"} options={['No preference', 'Volvo', 'As safe as possible', 'Mediocre', 'Motorcycle']} onChange={handleDropdownChange} />
            </div>
